...
namespace ExtraLINQ
{
    ...
    public static class EnumerableExtensions
    {
        ...
        /// </returns>
        /// <exception cref="System.ArgumentException">Thrown when <paramref name="expectedMaxItemCount"/> is negative.</exception>
        /// <exception cref="System.ArgumentNullException">Thrown when <paramref name="source"/> is null.</exception>
        ...
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source"/>.</typeparam>
        /// <param name="source">The <see cref="System.Collections.Generic.IEnumerable{TSource}"/>containing the item.</param>
        /// <param name="index">The item's index.</param>
        /// <param name="indexingStrategy">The <see cref="IndexingStrategy"/> to use.</param>
        /// <returns>The item at the specified index.</returns>
        /// <exception cref="System.ArgumentException">Thrown when <paramref name="source"/> is empty.</exception>
        /// <exception cref="System.ArgumentNullException">Thrown when <paramref name="source"/> is null.</exception>

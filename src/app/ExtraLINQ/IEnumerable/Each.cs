...
namespace ExtraLinq
{
    public static partial class EnumerableExtensions
    {
        ...
        public static IEnumerable<TSource> Each<TSource>(this IEnumerable<TSource> source, Action<TSource> action)
        {
            ...
            return EachIterator(source, action);
        }

        private static IEnumerable<TSource> EachIterator<TSource>(IEnumerable<TSource> source, Action<TSource> action)
        {
        ...
        private static IEnumerable<TSource> EachIterator<TSource>(IEnumerable<TSource> source, Action<TSource, int> action)
        {
            int index = 0;

...
namespace ExtraLinq.Tests
{
    public class ShuffleTests
    {
        ...
        [Fact]
        public static void Eagerly_throws_ArgumentNullException_when_sequence_is_null_with_random()
        {
            IEnumerable<char> nullSequence = null;
        ...
        [Fact]
        public static void Eagerly_throws_ArgumentNullException_when_random_is_null()
        {
        ...
        [Fact]
        public static void Uses_the_specified_random_number_generator()
        {
            IEnumerable<char> letters = "abcde";
